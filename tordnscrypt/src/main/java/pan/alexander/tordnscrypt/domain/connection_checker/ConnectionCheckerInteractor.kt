...
interface ConnectionCheckerInteractor {
    fun <T : OnInternetConnectionCheckedListener> addListener(listener: T)
    fun checkInternetConnection()
    fun <T : OnInternetConnectionCheckedListener> removeListener(listener: T)
    fun getInternetConnectionResult(): Boolean
