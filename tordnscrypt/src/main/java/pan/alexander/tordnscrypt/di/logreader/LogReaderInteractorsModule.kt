...
@Module
abstract class LogReaderInteractorsModule {
    @Binds
    abstract fun provideDnsCryptInteractor(
        logReaderInteractors: LogReaderInteractors
    ): DNSCryptInteractorInterface

    @Binds
    abstract fun provideTorInteractor(
        logReaderInteractors: LogReaderInteractors
    ): TorInteractorInterface

    @Binds
    abstract fun provideITPDInteractor(
        logReaderInteractors: LogReaderInteractors
    ): ITPDInteractorInterface

    @Binds
    abstract fun provideConnectionRecordsInteractor(
        logReaderInteractors: LogReaderInteractors
